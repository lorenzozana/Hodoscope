...
// Fri May 29 14:32:32 2015 by ROOT version 5.34/21
// from TChain Physics/
//////////////////////////////////////////////////////////

#ifndef analysis150_h
#define analysis150_h
...
class analysis150 : public TSelector {
public :
   ...
   analysis150(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~analysis150() { }
   ...
   ClassDef(analysis150,0);
};

#endif

#ifdef analysis150_cxx
void analysis150::Init(TTree *tree)
{
