...
// Fri May 29 14:32:40 2015 by ROOT version 5.34/21
// from TChain Physics/
//////////////////////////////////////////////////////////

#ifndef analysis200_h
#define analysis200_h
...
class analysis200 : public TSelector {
public :
   ...
   analysis200(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~analysis200() { }
   ...
   ClassDef(analysis200,0);
};

#endif

#ifdef analysis200_cxx
void analysis200::Init(TTree *tree)
{
