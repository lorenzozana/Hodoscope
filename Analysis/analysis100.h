...
// Fri May 29 14:32:24 2015 by ROOT version 5.34/21
// from TChain Physics/
//////////////////////////////////////////////////////////

#ifndef analysis100_h
#define analysis100_h
...
class analysis100 : public TSelector {
public :
   ...
   analysis100(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~analysis100() { }
   ...
   ClassDef(analysis100,0);
};

#endif

#ifdef analysis100_cxx
void analysis100::Init(TTree *tree)
{
